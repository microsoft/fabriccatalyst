...
Through this portal, partners can access:
...
Visit our [Fabric Catalyst Portal](https://microsoft.github.io/fabriccatalyst/) to:
- Explore Fabric experiences patterns
- Access Hands-on Labs
- Register for Upcoming Webinars
- Learn about Microsoft Fabric Architectures
...
For details on our security policy and how to report security issues, please see our [Security Policy](SECURITY.md).
